  ...
  builder(yargs) {
    return yargs
      ...
      .positional("default-config", {
        describe:
          "Node config, this should be a path to a file or JSON and will be merged with the default config. See https://github.com/ipfs/js-ipfs#optionsconfig",
        type: "string"
      })
      .option("bits", {
        type: "number",
        ...
        default: "2048",
        describe:
          "Number of bits to use in the generated RSA private key (defaults to 2048)"
      })
      .option("emptyRepo", {
        alias: "e",
        type: "boolean",
      ...
      (async () => {
        ...
        if (argv.defaultConfig) {
          try {
            ...
            debug(error);
            throw new Error(
              "Default config couldn't be found or content isn't valid JSON."
            );
          }
        }
