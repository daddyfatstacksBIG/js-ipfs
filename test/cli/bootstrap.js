  ...
  runOnAndOff(thing => {
    ...
    it("add another bootstrap node", async function() {
      ...
      const out = await ipfs(
        "bootstrap add /ip4/111.111.111.111/tcp/1001/ipfs/QmcyFFKfLDGJKwufn2GeitxvhricsBQyNKTkrD14psikoD"
      );
      expect(out).to.equal(
        "/ip4/111.111.111.111/tcp/1001/ipfs/QmcyFFKfLDGJKwufn2GeitxvhricsBQyNKTkrD14psikoD\n"
      );
    ...
    it("rm a bootstrap node", async function() {
      ...
      const out = await ipfs(
        "bootstrap rm /ip4/111.111.111.111/tcp/1001/ipfs/QmcyFFKfLDGJKwufn2GeitxvhricsBQyNKTkrD14psikoD"
      );
      expect(out).to.equal(
        "/ip4/111.111.111.111/tcp/1001/ipfs/QmcyFFKfLDGJKwufn2GeitxvhricsBQyNKTkrD14psikoD\n"
      );
