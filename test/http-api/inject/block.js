    ...
    describe("/block/get", () => {
      ...
      it("returns value", async () => {
        const res = await api.inject({
          method: "GET",
          url:
            "/api/v0/block/get?arg=QmZjTnYw2TFhn9Nn7tjmPSoTBoY7YRkwPzwSrSbabY24Kp"
        });
    ...
    describe("/block/stat", () => {
      ...
      it("returns value", async () => {
        const res = await api.inject({
          method: "GET",
          url:
            "/api/v0/block/stat?arg=QmZjTnYw2TFhn9Nn7tjmPSoTBoY7YRkwPzwSrSbabY24Kp"
        });

        expect(res.statusCode).to.equal(200);
        expect(res.result.Key).to.equal(
    ...
    describe("/block/rm", () => {
      ...
      it("returns 200", async () => {
        const res = await api.inject({
          method: "GET",
          url:
            "/api/v0/block/rm?arg=QmZjTnYw2TFhn9Nn7tjmPSoTBoY7YRkwPzwSrSbabY24Kp"
        });
