  ...
  describe("/object", () => {
    ...
    describe("/new", () => {
      it("returns value", async () => {
        ...
        expect(res.result.Hash).to.equal(
    ...
    describe("/get", () => {
      ...
      it("returns value", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/get?arg=QmdfTbBqBPQ7VNxZEYEj14VmRuZBkqFbiwReogJgS1zR1n"
        });
    ...
    describe("/put", () => {
      ...
      it.skip("should put data and return a base64 encoded CID", async () => {
        ...
        form.append(
          "file",
          JSON.stringify({ Data: "TEST" + Date.now(), Links: [] }),
          { filename: "node.json" }
        );
        const headers = form.getHeaders();
    ...
    describe("/stat", () => {
      ...
      it("returns value", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/stat?arg=QmZZmY4KCu9r3e7M2Pcn46Fc5qbn6NpzaAGaYb22kbfTqm"
        });

        expect(res.statusCode).to.equal(200);
        expect(res.result.Hash).to.equal(
          "QmZZmY4KCu9r3e7M2Pcn46Fc5qbn6NpzaAGaYb22kbfTqm"
        );
    ...
    describe("/data", () => {
      ...
      it("returns value", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/data?arg=QmZZmY4KCu9r3e7M2Pcn46Fc5qbn6NpzaAGaYb22kbfTqm"
        });
    ...
    describe("/links", () => {
      ...
      it("returns value", async () => {
        ...
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/links?arg=QmZZmY4KCu9r3e7M2Pcn46Fc5qbn6NpzaAGaYb22kbfTqm"
        });
      ...
      it.skip("should list object links and return a base64 encoded CID", async () => {
        ...
        expect(multibase.isEncoded(res.result.Links[0].Hash)).to.deep.equal(
          "base64"
        );
      });
    ...
    describe("/patch/append-data", () => {
      ...
      it("returns 400 if no data is provided", async () => {
        ...
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/append-data?arg=QmVLUHkjGg3duGb5w3dnwK5w2P9QWuJmtVNuDPLc9ZDjzk",
          headers,
          payload
        });
      ...
      it("updates value", async () => {
        ...
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/append-data?arg=QmdfTbBqBPQ7VNxZEYEj14VmRuZBkqFbiwReogJgS1zR1n",
          headers,
          payload
        });
      ...
      it.skip("should append data to object and return a base64 encoded CID", async () => {
        ...
        res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/append-data?cid-base=base64&arg=" +
            res.result.Hash,
          headers,
          payload
        });
      ...
      it("should not append data to object for invalid cid-base option", async () => {
        ...
        res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/append-data?cid-base=invalid&arg=" +
            res.result.Hash,
          headers,
          payload
        });
    ...
    describe("/patch/set-data", () => {
      ...
      it("returns 400 if no data is provided", async () => {
        ...
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/set-data?arg=QmVLUHkjGg3duGb5w3dnwK5w2P9QWuJmtVNuDPLc9ZDjzk",
          headers,
          payload
        });
      ...
      it("updates value", async () => {
        ...
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/set-data?arg=QmfY37rjbPCZRnhvvJuQ46htW3VCAWziVB991P79h6WSv6",
          headers,
          payload
        });
      ...
      it.skip("should set data for object and return a base64 encoded CID", async () => {
        ...
        res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/set-data?cid-base=base64&arg=" +
            res.result.Hash,
          headers,
          payload
        });
      ...
      it("should not set data for object for invalid cid-base option", async () => {
        ...
        res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/set-data?cid-base=invalid&arg=" +
            res.result.Hash,
          headers,
          payload
        });
    ...
    describe("/patch/add-link", () => {
      ...
      it("returns 400 for request with invalid first argument", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/add-link?arg=&arg=foo&arg=QmTz3oc4gdpRMKP2sdGUPZTAGRngqjsi99BPoztyP53JMM"
        });
      ...
      it("returns 400 for request with empty second argument", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/add-link?arg=QmUNLLsPACCz1vLxQVkXqqLX5R1X345qqfHbsf67hvA3Nn&arg=&arg=QmTz3oc4gdpRMKP2sdGUPZTAGRngqjsi99BPoztyP53JMM"
        });
      ...
      it("returns value", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/add-link?arg=QmdfTbBqBPQ7VNxZEYEj14VmRuZBkqFbiwReogJgS1zR1n&arg=foo&arg=QmUNLLsPACCz1vLxQVkXqqLX5R1X345qqfHbsf67hvA3Nn"
        });
    ...
    describe("/patch/rm-link", () => {
      ...
      it("returns 400 for request with invalid second argument", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/rm-link?arg=QmZKetgwm4o3LhNaoLSHv32wBhTwj9FBwAdSchDMKyFQEx&arg="
        });
      ...
      it("returns value", async () => {
        const res = await api.inject({
          method: "POST",
          url:
            "/api/v0/object/patch/rm-link?arg=QmdVHE8fUD6FLNLugtNxqDFyhaCgdob372hs6BYEe75VAK&arg=foo"
        });
